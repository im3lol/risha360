...
| **[DOCKER.md](DOCKER.md)** | Step-by-step guide to running the whole project on Docker — services, ports, start/stop, keeping it running 24/7, the IG session, applying changes, and troubleshooting. |
