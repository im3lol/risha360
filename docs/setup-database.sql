-- ============================================================================
-- Risha 360 — COMPLETE DATABASE SETUP (run once)
-- ----------------------------------------------------------------------------
-- Paste this whole file into the Supabase SQL Editor and Run. It builds the
-- entire schema in the correct order:
--   1) Base schema  (tables, RPCs, RLS, triggers, seeds)
--   2) Migration 003 (persist full scoring + authenticity signals)
--   3) Migration 004 (dashboard control columns on discovery_agent_settings)
--   4) Migration 005 (revoke API-key columns from authenticated/anon)
-- Every statement is idempotent / safe to re-run.
-- Generated from: supabase-migration.sql + migrations/003,004,005.
-- ============================================================================
...
-- ================= 4) MIGRATION 005 (protect API keys) ====================
